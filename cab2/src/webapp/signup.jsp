...
<p class="text-center test-success fs-3">${sucMsg}</p>
...
<div class="mb-3">
		<label class="form.label">Mobile Number</label><input required name="mobile" type="text" class="form-control">
</div>
	<div class="mb-3">
		<label class="form.label">Email Address</label><input required name="email" type="text" class="form-control">
</div>
<div class="mb-3">
